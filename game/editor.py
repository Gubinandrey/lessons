...
class Editor:
    ...
    def __init__(self):
        ...
        self.tile_size = 16 # the current size of the tiles
    ...
    def _load_resources(self):
        ...
        for dirname in os.listdir(RESOURCES_DIR):
            if not os.path.isdir(os.path.join(RESOURCES_DIR, dirname)): 
                continue
    ...
    def load(self):
        ...
        try:
            with open(path, 'r') as f:
                ...
                self.nogrid_tiles = data['off_grid']
